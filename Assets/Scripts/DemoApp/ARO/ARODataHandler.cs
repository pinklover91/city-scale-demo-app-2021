...
namespace Immersal.Samples.DemoApp.ARO
{
    public class ARODataHandler : MonoBehaviour
    {
        ...
        {
            AROManagerGlobal.Instance.UpdateAROData(uid, currentData);
        }
        ...
        public void TryToMoveARO()
        {
            ...
            {
                Lock();
                AROManagerGlobal.Instance.PlaceAROWithPlacer(uid);
            }
        }
        ...
        public void MoveTo(Pose newWorldPose)
        {
            if (!IsLocked())
            {
                AROManagerGlobal.Instance.PlaceARO(uid, newWorldPose);
            }
        }
        ...
        {
            AROManagerGlobal.Instance.DeleteARO(uid);
        }
